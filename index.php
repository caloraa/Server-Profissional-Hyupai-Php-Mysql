...
<head>
    ...
    <title>Admin Panel - Inicio</title>
    <meta name="description" content="Ela Admin - HTML5 Admin Template">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="https://i.imgur.com/e79bkFi.png">
    <link rel="shortcut icon" href="https://i.imgur.com/e79bkFi.png">
...
echo "<div class='sufee-alert alert with-close alert-danger alert-dismissible fade show'>
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Visão Geral dos Usuarios</h4>
                                </div>
                                <div class="card-body--">
                                    <div class="table-stats order-table ov-h">
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <?php
$fetchqry = "SELECT * FROM `$tabela` LIMIT 30";
...
echo "<div class='sufee-alert alert with-close alert-danger alert-dismissible fade show'>
                     ...
                     <div class="row">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Visão Geral dos Vendedores</h4>
                                </div>
                                <div class="card-body--">
                                    <div class="table-stats order-table ov-h">
                                        <table class="table ">
                                            <thead>
                                             ...
                                             <?php
$fetchqry2 = "SELECT * FROM `$tabela3` LIMIT 30";
...
while ($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) { ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row2['senha'];?></td>
                                                    <td> <?php echo $row2['creditos'];?></td>
                                                </tr>
<?php } ?>
                                            </tbody>
                                        </table>
