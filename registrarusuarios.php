                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="datetime-local" id="validade" name="validade" placeholder="Validade" class="form-control" data-required="true" data-error-message="Insira a validade" required>
                                    </div>
                                </div>
