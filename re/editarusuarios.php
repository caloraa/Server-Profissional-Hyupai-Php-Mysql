...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            $sqla = "SELECT Username FROM $tabela WHERE Username = '$UsernameOld' AND `Vendedor` = '$Vendedor'";
...
$sts = $dados5['status'];
            ...
            if($Validadee != NULL || $Validadee != "") {
                 ...
                 $cc4 = "SELECT * FROM $tabela WHERE Username = '$UsernameOld' AND `Vendedor` = '$Vendedor'";
