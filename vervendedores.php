                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Lista de Vendedores</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Creditos</th>
                                             <th>Remover</th>
                                              <th>Adicionar Creditos</th>
                                        
                                        </tr>
                                    </thead>
                                    <tbody>
                                         <?php
$fetchqry = "SELECT * FROM `$tabela3`";
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='act6.php?no=".$row['id']."'><button type='button' class='btn btn-danger'>Apagar</button></a>";?></td>
                                            <td><?php echo "<a href='creditos.php?no=".$row[$static]."'><button type='button' class='btn btn-danger'>Adicionar Creditos</button></a>";?></td>
                                        </tr>
                                         <?php } ?>
                                    </tbody>
                                </table>
