...
<head>
    ...
    <title>Ver Dispositivos Banidos</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Dispositivos Banidos:</strong>
                            </div>
                            <div class="card-body">
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) { 
    ...
    ?>
                                     ...
                                     <td><?php echo "<a href='act4.php?no=$device&no2=$user'><button type='button' class='btn btn-danger'>Apagar</button></a>";?></td>
