...
<head>
    ...
    <title>Remover Vendedores</title>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">Remover Vendedores</div>
...
<?php  if(isset($_POST['action'])) {
 ...
 $sqla = "SELECT $static FROM $tabela3 WHERE $static = '$Username'";
        ...
        if(mysqli_num_rows($resultadoa) == 0) {
                ...
                $update = "DELETE FROM `$tabela3` WHERE `$static` = '$Username'";

$onupdate = mysqli_query($conn,$update);

  $a = 'ilogs.txt';
     $b = file_get_contents('ilogs.txt');
     $c = str_replace($Username,null,$b);
     file_put_contents($a, $c); 

$name = 'logusers.txt';
$text = "$StartDate - O Vendedor: $Username foi deletado por $Vendedor\n";
$file = fopen($name, 'a');
fwrite($file, $text);
fclose($file);
